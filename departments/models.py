...
class Department(models.Model):
    ...
    depart_head = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='departments', on_delete=models.CASCADE)
...
class Employee(models.Model):
    ...
    depart_head = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='department', on_delete=models.CASCADE)
